...
SELECT * FROM shane_bvu1_roads.osm_roads
WHERE osm_id NOT IN (
...
-- checkpoint --
	-- what's in? --
SELECT * FROM shane_bvu1_roads.osm_roads_add_lanes
	-- what's not in? --
SELECT * FROM shane_bvu1_roads.osm_roads
WHERE osm_id NOT IN (
	SELECT osm_id FROM shane_bvu1_roads.osm_roads_add_lanes
...
SELECT * FROM shane_bvu1_roads.osm_roads
WHERE osm_id NOT IN (
	SELECT osm_id FROM shane_bvu1_roads.conflation_road_case crc 
);

SELECT * FROM shane_bvu1_roads.arnold_lines 
...
--INSERT INTO shane_bvu1_roads.conflation_road_case (
--	osm_id, 
--	osm_road_name,
--	lanes,
--	osm_geom, 
...
-- check point -- 
SELECT * FROM shane_bvu1_roads.conflation_road_case -- count: 101
